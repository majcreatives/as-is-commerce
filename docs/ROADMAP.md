...
| 31.5 | Registration redesign — two-column desktop layout, show/hide password toggle, clearer phone helper; consent line deferred with the 31.3 legal pages | deployed on `stage31.5`; verified & deployed on staging (2026-09-24) — see `VERIFY_31_5_REGISTRATION_REDESIGN.md` |
